    ...
    <div class="container">
        ...
        <?php } ?>
            ...
            <div id="main">
                ...
                <?php 				 				 if(drupal_is_front_page()) {					unset($page['content']['system_main']['default_message']);					}				 print render($page['content']); 				 								//print render($page['content']); ?>
	...
	<div id="footer" style="padding:0 !important;">
        <div class="container">
        	<div class="sixteen columns clearfix">
                ...
                <div id="credits" style="background-color: #1c2d3f !important; color: #98abb9;">
				
				<table>
				<tr style="background-color: #1c2d3f !important; color: #98abb9; border-top:1px solid #98abb9 !important;">
					<td style="width:66%;">
						<li style="display: inline;margin-right:10px; float:left ;">AVISO LEGAL</li>
						<li style="display: inline; float:left ;">POLITICA DE COOKIES</li>
					</td>
					<td class=' red-social' style="width:33%; float:right;">
						<li style="display: inline;margin-right:10px;float:left !important;"><span>Siga-nos</span></li>
						<li style="display: inline;">
                <a href="https://www.facebook.com/GrupoBBVA/" target="_blank">
                    <button class="icon-fb icon-footer-t " style="font-size: 18px;"></button>
                </a>
                <a href="https://www.youtube.com/user/bbva" target="_blank">
                    <button class="icon-youtube icon-footer-t" style="font-size: 18px;"></button>
                </a>
                <a href="https://www.linkedin.com/company/bbva" target="_blank">
                    <button class="icon-linkedin icon-footer-t " style="font-size: 18px;"></button>
                </a>
                <a href="https://twitter.com/BBVA" target="_blank">
                    <button class="icon-twitter icon-footer-t" style="font-size: 18px;"></button>
                </a>
                <a href="https://plus.google.com/u/0/116515550915076317173" target="_blank">
                    <button class="icon-google-plus-nuevo icon-footer-t" style="font-size: 18px;"></button>
                </a>
			</div></li>
					</td>
				</tr>
